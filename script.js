...
{
 // Define the endpoint URL for the Chicago Data Portal
const endpoint = "https://data.cityofchicago.org/resource/7as2-ds3y.json";

// Define parameters for the API request
const params = {
    "$limit": 1000,                  // Limit the result to 1000 records
    "$where": "status='Open'",        // Optional: Only get open pothole requests
    "$order": "creation_date DESC"    // Sort by most recent pothole requests
};
...
fetch(url)
    ...
    .then(data => {
       console.log(data);  // Log the data (array of objects)
        return data
    })
    .catch(error => {
